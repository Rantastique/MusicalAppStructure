...
public class ArtistDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nowPlaying.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nowPlayingIntent = new Intent(ArtistDetailActivity.this, NowPlayingActivity.class);
    ...
    public void changeArrow(View view) {
        ...
        if (isExplanationHidden) {
            ...
            explanation.setText(getResources().getString(R.string.explanation_artist_detail));
