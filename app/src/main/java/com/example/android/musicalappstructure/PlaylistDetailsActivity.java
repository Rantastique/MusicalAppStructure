...
public class PlaylistDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nowPlaying.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent nowPlayingIntent = new Intent(PlaylistDetailsActivity.this, NowPlayingActivity.class);
    ...
    public void changeArrow(View view) {
        ...
        if (isExplanationHidden) {
            ...
            explanation.setText(getResources().getString(R.string.explanation_playlist_details));
